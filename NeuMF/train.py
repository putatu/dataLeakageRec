...
def parse_args():
    ...
    parser.add_argument('--test_year', nargs = '?', type =int, default = 5, help='test year')
...
data_path = args.data_path #data path

test_year = args.test_year #test year: 5 or 7
dataset_name = args.data #dataset: movielens, yelp, amazon-music or amazon-electronic
num_years_added = args.num_years_added #number of years of future data added
mode = "train"
...
regs = args.regs #regularization coefficients
learning_rate = args.learning_rate #learning rate
num_negatives = args.num_negatives #number of negative samples
mf_dim = args.mf_dim #embedding dimension
